...
The Raspberry Debugger writes detailed log information to the Visual Studio Debug Output Window.  This is intended to give you some idea of what happened then things go wrong.
